...
const CACHE = 'genbient-v25';
const SHELL = [
  './', 'index.html', 'css/style.css', 'manifest.webmanifest',
  'js/main.js', 'js/engine.js', 'js/scenes.js', 'js/theory.js', 'js/util.js', 'js/visuals.js', 'js/params.js',
  'js/composer.js', 'js/progressions.js', 'js/touch.js', 'js/conductor.js', 'js/recorder.js', 'js/stepsense.js', 'js/recorder-worklet.js', 'js/layers/index.js', 'js/layers/base.js', 'js/layers/tonal.js',
